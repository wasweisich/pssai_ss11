...
public class TravelingTournamentProblem {
    ...
    public TTPResult run(TTPParameters parameters) throws Exception {
        ...
        if (parameters.getMaxDuration() != Long.MAX_VALUE) {
            ...
            System.out.println("Time Limit   : " + hours + " hours, " + minutes + " minutes, " + seconds + " seconds");
        } else
        ...
        writeParametersFile(parameters.getConstructionHeuristic(), parameters.getGraspTries(),
                parameters.getInstanceFile(), parameters.getIterationsWithoutImprovement(), parameters.getMethod(),
                parameters.getNeighborhoods(), parameters.getOutputDirectory(), parameters.getTabuListLength(),
                parameters.getThreadCount(), parameters.getVirtualScheduleConstructionMethod(),
        ...
        if (parameters.getMaxDuration() != Long.MAX_VALUE) {
            ...
            finishTime.setTime(finishTime.getTime() + parameters.getMaxDuration());
    ...
    private static void writeParametersFile(ConstructionHeuristic constructionHeuristic, int graspTries,
        ...
        if (parameterOutFile.createNewFile()) {
            ...
            if (maxDuration != Long.MAX_VALUE) {
                ...
                parameterWriter.println(
                        "Time Limit   : " + hours + " hours, " + minutes + " minutes, " + seconds + " seconds");
            } else
